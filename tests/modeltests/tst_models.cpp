...
private slots:
    ...
    void testPrettySymbol_data()
    {
        ...
        QTest::newRow("nested types")
            ...
            " std::less<int>, std::allocator<std::pair<int const, std::__cxx11::basic_string<char, std::char_traits<char>,"
            " std::allocator<char> > > > > > > > > >";
        QTest::newRow("standard type")
            << "int" << "int";
        QTest::newRow("custom type")
            << "TFoo" << "TFoo";
        ...
        QTest::newRow("unordered_multimap")
