...
```
apt-get install libkf5threadweaver-dev libkf5i18n-dev libkf5configwidgets-dev libkf5coreaddons-dev libkf5itemviews-dev libkf5itemmodels-dev kio-dev libkf5solid-dev libelf-dev libdw-dev cmake extra-cmake-modules gettext
```
